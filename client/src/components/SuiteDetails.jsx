...
//             component="img"
//             height="400"
//             image={'http://localhost:5000/uploads/'+suite.image} // כאן נשלים את כתובת התמונה של הצימר
//             alt={suite.name}
//           />
...
//               {suite.address} {suite.city} {/* כתובת הצימר */}
//             </Typography>
//             <Typography variant="body1" >
//               {suite.description}{/* תאור הצימר */}
//             </Typography>
//             <Typography variant="body2" sx={{ mt: 2 }}>
//               {responses.length>0 ? responses.map((response) => (
//                 <Box key={response._id} sx={{ mb: 1 }}>
